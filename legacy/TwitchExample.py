...
async def run():
    ...
    await event_sub.listen_channel_points_automatic_reward_redemption_add(user_id, on_automatic_redemption)
    await event_sub.listen_channel_points_custom_reward_redemption_add(user_id, on_custom_redemption)
